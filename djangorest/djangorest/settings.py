...
AUTHENTICATION_BACKENDS = [
    'assgn1.backends.email.EmailBackend',
...
with open(BASE_DIR / 'hello.txt', 'r') as f:
    passd = f.readline()
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'saifmulla164@gmail.com'
EMAIL_HOST_PASSWORD = str(passd)
